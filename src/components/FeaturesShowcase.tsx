          ...
          <div className="relative order-2">
            <div className="aspect-[3/4] max-w-xs sm:max-w-sm mx-auto overflow-hidden border-2 border-border relative rounded-lg">
              ...
              <div className="absolute bottom-0 left-0 right-0 p-4 sm:p-6">
                ...
                <Button 
                  variant="outline" 
                  className="w-full border-border/50 bg-card/50 backdrop-blur-sm hover:border-foreground/50 hover:text-foreground hover:bg-secondary font-display uppercase tracking-wide text-xs sm:text-sm py-2 sm:py-3 rounded-2xl transition-all duration-300"
                >
                  LER AGORA
                </Button>
              </div>
