        ...
        <div className="relative gradient-border p-12 md:p-16 text-center noise-bg">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            ...
            <Button 
              size="lg" 
              variant="outline" 
              className="w-full sm:w-auto border-border/50 bg-card/50 backdrop-blur-sm hover:border-accent hover:text-accent hover:bg-accent/10 px-10 py-6 text-base rounded-2xl font-display uppercase tracking-wider transition-all duration-300"
            >
              Explorar Catálogo
            </Button>
          </div>
