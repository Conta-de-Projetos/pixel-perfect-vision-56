...
const Navbar = () => {
  ...
  return (
    <>
      <header className="fixed top-0 left-0 right-0 z-50 hidden lg:block"> {/* Hidden on mobile (lg:hidden) */}
              ...
              <div className="lg:hidden pt-4 pb-2 animate-fade-up border-t border-border mt-4">
                <div className="flex flex-col gap-1">
                  ...
                  <div className="flex gap-2 mt-4 pt-4 border-t border-border">
                    <Button variant="outline" className="flex-1 font-display uppercase" onClick={() => setIsMobileMenuOpen(false)}>
                      Entrar
                    </Button>
                    <Button className="flex-1 font-display uppercase" onClick={() => setIsMobileMenuOpen(false)}>
                      Criar Conta
                    </Button>
                  </div>
                </div>
