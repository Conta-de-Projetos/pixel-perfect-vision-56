...
export const allMangas: MangaData[] = [
  ...
  },
  {
    ...
    title: "Solo Leveling",
    chapter: "Cap. 179",
    imageUrl: coverImages.soloLeveling,
    rating: 9.9,
    isNew: false,
    isPremium: true,
    type: 'manhwa',
    ...
    synopsis: 'Em um mundo onde caçadores lutam contra monstros, Sung Jinwoo, o caçador mais fraco, ganha um sistema misterioso que o permite subir de nível infinitamente.',
    slug: 'solo-leveling',
    tags: ['Ação', 'Fantasia', 'Isekai', 'Manhwa'],
    year: 2018,
  ...
  },
  {
    ...
    synopsis: 'Monkey D. Luffy e sua tripulação, os Piratas do Chapéu de Palha, navegam pela Grand Line em busca do tesouro One Piece para se tornar o Rei dos Piratas.',
    slug: 'one-piece',
    tags: ['Aventura', 'Fantasia', 'Shounen', 'Comédia'],
    year: 1997,
    originalLanguage: 'Japonês',
    demography: 'Shounen',
    ageRating: '12+',
  },
  {
    ...
    title: "Demon Slayer",
    chapter: "Cap. 205",
    imageUrl: coverImages.demonSlayer,
    rating: 9.6,
    isNew: false,
    isPremium: false,
    type: 'manga',
    ...
    synopsis: 'Tanjiro Kamado se torna um caçador de demônios após sua família ser massacrada e sua irmã Nezuko ser transformada em um demônio.',
    slug: 'demon-slayer',
    tags: ['Ação', 'Sobrenatural', 'Fantasia', 'Shounen'],
    year: 2016,
    originalLanguage: 'Japonês',
    demography: 'Shounen',
    ageRating: '14+',
